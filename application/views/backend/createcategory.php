            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createcategorysubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
                        ...
                        <div class=" form-group">
                            <label class="col-sm-2 control-label" for="normal-field">Ministry</label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown( "ministry",$ministry,set_value( 'ministry'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
                        <div class="form-group">
